...
public class Messages {
    ...
    public static final String DEFAULT = "if you don't know commands please write help";
    ...
    public static final String ID_NOT_DIGITS = "id is not digits";
    ...
    public static final String IN_COMMANDS = ">";
